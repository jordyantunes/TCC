...
static const int mindist = 5;
//static const int mindist = 2;
static const int window_size = 7;
/*Alterei o mínimo de 1 para 0*/
static const int min_eigenvalue = 0;
...
static const int affine_max_iterations = 20;
